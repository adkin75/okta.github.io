...
function check_sample_code_orgs() {
    ...
    local subdomainUrls=$(grep -EoR "(http|https)://your-subdomain.okta*" --include="*.md" $dir --exclude-dir={node_modules,scripts,tests,dist,_docs/platform-release-notes} | sort | uniq)
