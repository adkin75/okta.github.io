...
- The URL for your new Okta org (for example: https://{oktaDomain}.com)
...
```
import-stormpath --stormPathBaseDir /path/to/export/data --oktaBaseUrl https://{oktaDomain}.com --oktaApiToken yourApiToken
```
...
- `--oktaBaseUrl (-u)`: Base URL of your Okta tenant
    ...
    - Example: `--oktaBaseUrl https://{oktaDomain}.com`
