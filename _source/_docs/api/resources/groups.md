...
}' "https://{oktaDomain}.com/api/v1/groups"
~~~
...
~~~json
{
  ...
  "_links": {
    "logo": [
      {
        "name": "medium",
        "href": "https://{oktaDomain}.com/img/logos/groups/okta-medium.png",
        "type": "image/png"
      },
      {
        "name": "large",
        "href": "https://{oktaDomain}.com/img/logos/groups/okta-large.png",
        "type": "image/png"
      }
    ],
    "users": {
      "href": "https://{oktaDomain}.com/api/v1/groups/00g1emaKYZTWRYYRRTSK/users"
    },
    "apps": {
      "href": "https://{oktaDomain}.com/api/v1/groups/00g1emaKYZTWRYYRRTSK/apps"
    }
  }
}
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/groups/00g1emaKYZTWRYYRRTSK"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/groups?limit=200"
~~~
...
Link: <https://{oktaDomain}.com/api/v1/groups?limit=200>; rel="self"
Link: <https://{oktaDomain}.com/api/v1/groups?after=00garwpuyxHaWOkdV0g4&limit=200>; rel="next"
  ...
  },
  {
    ...
    "_links": {
      "logo": [
        {
          "name": "medium",
          "href": "https://{oktaDomain}.com/img/logos/groups/active_directory-medium.png",
          "type": "image/png"
        },
        {
          "name": "large",
          "href": "https://{oktaDomain}.com/img/logos/groups/active_directory-large.png",
          "type": "image/png"
        }
      ],
      "users": {
        "href": "https://{oktaDomain}.com/api/v1/groups/00garwpuyxHaWOkdV0g4/users"
      },
      "apps": {
        "href": "https://{oktaDomain}.com/api/v1/groups/00garwpuyxHaWOkdV0g4/apps"
      }
    }
  }
]
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/groups?q=West&limit=10"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/groups?filter=type+eq+\"OKTA_GROUP\"&limit=200"
~~~
...
HTTP/1.1 200 OK
Content-Type: application/json
Link: <https://{oktaDomain}.com/api/v1/groups?limit=2&filter=type+eq+%22OKTA_GROUP%22>; rel="self"
Link: <https://{oktaDomain}.com/api/v1/groups?after=00gak46y5hydV6NdM0g4&limit=2&filter=type+eq+%22OKTA_GROUP%22>; rel="next"
...
[
  ...
  },
  {
    ...
    "_links": {
      ...
      "users": {
        "href": "https://{oktaDomain}.com/api/v1/groups/00gak46y5hydV6NdM0g4/users"
      },
      "apps": {
        "href": "https://{oktaDomain}.com/api/v1/groups/00gak46y5hydV6NdM0g4/apps"
      }
    }
  }
]
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/groups?filter=lastUpdated+gt+\"2015-10-01T00:00:00.000Z\"&limit=200"
~~~
...
HTTP/1.1 200 OK
Content-Type: application/json
Link: <https://{oktaDomain}.com/api/v1/groups?limit=200&filter=lastUpdated+gt+%222015-10-01T00%3A00%3A00.000Z%22>; rel="self"
Link: <https://{oktaDomain}.com/api/v1/groups?after=00g1emaKYZTWRYYRRTSK&limit=200&filter=lastUpdated+gt+%222015-10-01T00%3A00%3A00.000Z%22>; rel="next"
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/groups?filter=lastMembershipUpdated+gt+\"2015-10-01T00:00:00.000Z\"&limit=200"
~~~
...
HTTP/1.1 200 OK
Content-Type: application/json
Link: <https://{oktaDomain}.com/api/v1/groups?limit=200&filter=lastMembershipUpdated+gt+%222015-10-01T00%3A00%3A00.000Z%22>; rel="self"
Link: <https://{oktaDomain}.com/api/v1/groups?after=00g1emaKYZTWRYYRRTSK&limit=200&filter=lastMembershipUpdated+gt+%222015-10-01T00%3A00%3A00.000Z%22>; rel="next"
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/groups?filter=lastUpdated+gt+\"2015-10-01T00:00:00.000Z\"+or+lastMembershipUpdated+gt+\"2015-10-01T00:00:00.000Z\"&limit=200"
~~~
...
HTTP/1.1 200 OK
Content-Type: application/json
Link: <https://{oktaDomain}.com/api/v1/groups?limit=200&filter=lastUpdated+gt+%222015-10-01T00%3A00%3A00.000Z%22+or+lastMembershipUpdated+gt+%222015-10-01T00%3A00%3A00.000Z%22>; rel="self"
Link: <https://{oktaDomain}.com/api/v1/groups?after=00g1emaKYZTWRYYRRTSK&limit=200&filter=lastUpdated+gt+%222015-10-01T00%3A00%3A00.000Z%22+or+lastMembershipUpdated+gt+%222015-10-01T00%3A00%3A00.000Z%22>; rel="next"
...
}' "https://{oktaDomain}.com/api/v1/groups/00ub0oNGTSWTBKOLGLNR"
~~~
...

{
  ...
  "_links": {
    ...
    "users": {
      "href": "https://{oktaDomain}.com/api/v1/groups/00ub0oNGTSWTBKOLGLNR/users"
    },
    "apps": {
      "href": "https://{oktaDomain}.com/api/v1/groups/00ub0oNGTSWTBKOLGLNR/apps"
    }
  }
}
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/groups/00g1fanEFIQHMQQJMHZP/users?limit=200"
~~~
...
HTTP/1.1 200 OK
Content-Type: application/json
Link: <https://{oktaDomain}.com/api/v1/groups/00g1fanEFIQHMQQJMHZP/users?limit=200>; rel="self"
Link: <https://{oktaDomain}.com/api/v1/groups/00g1fanEFIQHMQQJMHZP/users?after=00u1f9cMYQZFMPVXIDIZ&limit=200>; rel="next"
...
[
  {
    ...
    "_links": {
      "self": {
        "href": "https://{oktaDomain}.com/api/v1/users/00u1f96ECLNVOKVMUSEA"
      }
    }
  },
  {
    ...
    "_links": {
      "self": {
        "href": "https://{oktaDomain}.com/api/v1/users/00u1f9cMYQZFMPVXIDIZ"
      }
    }
  }
]
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/groups/00g1fanEFIQHMQQJMHZP/users/00u1f96ECLNVOKVMUSEA"
~~~
...
-d '{
    ...
    }' "https://{oktaDomain}.com/api/v1/groups/rules"
~~~
...
-d '{
    ...
    }' "https://{oktaDomain}.com/api/v1/groups/rules/0pr3f7zMZZHPgUoWO0g4"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/groups/rules?limit=30"
~~~
...
HTTP/1.1 200 OK
Content-Type: application/json
Link: <https://{oktaDomain}.com/api/v1/groups/rules?limit=20>; rel="self"
Link: <https://{oktaDomain}.com/api/v1/groups/rules?after=0pr3f7zMZZHPgUoWO0g4&limit=20>; rel="next"
[
  {
    "type": "group_rule",
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/groups/rules/0pr3f7zMZZHPgUoWO0g4/lifecycle/activate"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/groups/rules/0pr3f7zMZZHPgUoWO0g4/lifecycle/deactivate"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/groups/00g1fanEFIQHMQQJMHZP/apps"
~~~
...
HTTP/1.1 200 OK
Content-Type: application/json
Link: <https://{oktaDomain}.com/api/v1/groups/00g1fanEFIQHMQQJMHZP/apps>; rel="self"
Link: <https://{oktaDomain}.com/api/v1/groups/00g1fanEFIQHMQQJMHZP/apps?after=0oafxqCAJWWGELFTYASJ>; rel="next"
...
[
 {
        ...
        "_links": {
            "appLinks": [
                {
                    "href": "https://{oktaDomain}.com/home/template_basic_auth/0oafwvZDWJKVLDCUWUAC/1438",
                    "name": "login",
                    "type": "text/html"
                }
            ],
    ...
    },
    {
        ...
        "_links": {
            "appLinks": [
                {
                    "href": "https://{oktaDomain}.com/home/bookmark/0oafxqCAJWWGELFTYASJ/1280",
                    "name": "login",
                    "type": "text/html"
                }
            ],
