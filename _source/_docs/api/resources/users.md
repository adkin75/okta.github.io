...
}' "https://{oktaDomain}.com/api/v1/users?activate=false"
~~~
...
~~~json
{
  ...
  "_links": {
    "activate": {
      "href": "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/activate"
    }
  }
}
~~~
...
}' "https://{oktaDomain}.com/api/v1/users?provider=true"
~~~
...
~~~json
{
  ...
  "_links": {
    "resetPassword": {
      "href": "https://{oktaDomain}.com/api/v1/users/00uijntSwJjSHtDY70g3/lifecycle/reset_password",
      "method": "POST"
    },
    "changeRecoveryQuestion": {
      "href": "https://{oktaDomain}.com/api/v1/users/00uijntSwJjSHtDY70g3/credentials/change_recovery_question",
      "method": "POST"
    },
    "deactivate": {
      "href": "https://{oktaDomain}.com/api/v1/users/00uijntSwJjSHtDY70g3/lifecycle/deactivate",
      "method": "POST"
    }
  }
}
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/me"
~~~
...
~~~json
{
  ...
  "_links": {
    "resetPassword": {
      "href": "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/reset_password"
    },
    "resetFactors": {
      "href": "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/reset_factors"
    },
    "expirePassword": {
      "href": "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/expire_password"
    },
    "forgotPassword": {
      "href": "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/credentials/forgot_password"
    },
    "changeRecoveryQuestion": {
      "href": "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/credentials/change_recovery_question"
    },
    "deactivate": {
      "href": "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/deactivate"
    },
    "changePassword": {
      "href": "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/credentials/change_password"
    }
  }
}
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/isaac.brock@example.com"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/isaac.brock"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users?limit=200"
~~~
...
HTTP/1.1 200 OK
Content-Type: application/json
Link: <https://{oktaDomain}.com/api/v1/users?limit=200>; rel="self"
Link: <https://{oktaDomain}.com/api/v1/users?after=00ud4tVDDXYVKPXKVLCO&limit=200>; rel="next"
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users?q=eric&limit=1"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users?filter=status+eq+\"ACTIVE\"+or+status+eq+\"RECOVERY\""
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users?filter=lastUpdated+gt+\"2013-07-01T00:00:00.000Z\""
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users?search=profile.mobilePhone+sw+\"555\"+and+status+eq+\"ACTIVE\""
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users?search=profile.arrayAttr+eq+\"arrayAttrVal1\" "
~~~
...
[
    {
        ...
        "_links": {
            "self": {
                "href": "https://{oktaDomain}.com/api/v1/users/00u19uiKQa0xXkbdGLNR"
            }
        }
    }
]
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/appLinks"
~~~
...
[
  {
    ...
    "linkUrl": "https://{oktaDomain}.com/home/google/0oa3omz2i9XRNSRIHBZO/50",
    "logoUrl": "https://{oktaDomain}.com/img/logos/google-mail.png",
    "appName": "google",
  ...
  },
  {
    ...
    "linkUrl": "https://{oktaDomain}.com/home/google/0oa3omz2i9XRNSRIHBZO/54",
    "logoUrl": "https://{oktaDomain}.com/img/logos/google-calendar.png",
    "appName": "google",
    "appInstanceId": "0oa3omz2i9XRNSRIHBZO",
    "appAssignmentId": "0ua3omz7weMMMQJERBKY",
    "credentialsSetup": false,
  ...
  },
  {
    "id": "00ub0oNGTSWTBKOLGLNR",
    "label": "Box",
    "linkUrl": "https://{oktaDomain}.com/home/boxnet/0oa3ompioiQCSTOYXVBK/72",
    "logoUrl": "https://{oktaDomain}.com/img/logos/box.png",
    "appName": "boxnet",
  ...
  },
  {
    ...
    "linkUrl": "https://{oktaDomain}.com/home/salesforce/0oa12ecnxtBQMKOXJSMF/46",
    "logoUrl": "https://{oktaDomain}.com/img/logos/salesforce_logo.png",
    "appName": "salesforce",
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/groups"
~~~
...
~~~json
{
  "activationUrl": "https://{oktaDomain}.com/welcome/XE6wE17zmphl3KqAPFxO",
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/activate?sendEmail=false"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/reactivate?sendEmail=false"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/deactivate"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/suspend"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/unsuspend"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/unlock"
~~~
...
~~~json
{
  "resetPasswordUrl": "https://{oktaDomain}.com/reset_password/XE6wE17zmphl3KqAPFxO"
}
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/reset_password?sendEmail=false"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/reset_password?provider=FEDERATED&sendEmail=false"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/expire_password?tempPassword=false"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/lifecycle/reset_factors"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/${userId}/sessions"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/credentials/forgot_password?sendEmail=false"
~~~
...
}' "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/credentials/forgot_password"
~~~
...
}' "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/credentials/change_password"
~~~
...
}' "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/credentials/change_recovery_question"
~~~
