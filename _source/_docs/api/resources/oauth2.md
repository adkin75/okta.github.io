...
~~~sh
curl -X POST \
  "https://{oktaDomain}.com/oauth2/aus9s3ami4MRoqQR90h7/v1/token" \
...
~~~json
{
    ...
    "iss" : "https://{oktaDomain}.com/oauth2/orsmsg0aWLdnF3spV0g3",
...
~~~sh
curl -v -X GET \
"https://{oktaDomain}.com/oauth2/*:authorizationServerId*/v1/logout?
...
~~~json
{
    ...
    "authorization_endpoint": "https://{oktaDomain}.com/oauth2/{authorizationServerId}/v1/authorize",
    "token_endpoint": "https://{oktaDomain}.com/oauth2/{authorizationServerId}/v1/token",
    "registration_endpoint": "https://{oktaDomain}.com/oauth2/v1/clients",
    "jwks_uri": "https://{oktaDomain}.com/oauth2/{authorizationServerId}/v1/keys",
    ...
    "introspection_endpoint": "https://{oktaDomain}.com/oauth2/{authorizationServerId}/v1/introspect",
    ...
    "revocation_endpoint": "https://{oktaDomain}.com/oauth2/{authorizationServerId}/v1/revoke",
...
~~~json
{
    ...
    "authorization_endpoint": "https://{oktaDomain}.com/oauth2/{authorizationServerId}/v1/authorize",
    "token_endpoint": "https://{oktaDomain}.com/oauth2/{authorizationServerId}/v1/token",
    "userinfo_endpoint": "https://{oktaDomain}.com/oauth2/{authorizationServerId}/v1/userinfo",
    "registration_endpoint": "https://{oktaDomain}.com/oauth2/v1/clients",
    "jwks_uri": "https://{oktaDomain}.com/oauth2/{authorizationServerId}/v1/keys",
    "response_types_supported": [
        "code",
...
}' "https://{oktaDomain}.com/api/v1/authorizationServers"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/authorizationServers/aus5m9r1o4AsDJLe50g4"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/authorizationServers/aus1sb3dl8L5WoTOO0g7/lifecycle/activate"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/authorizationServers/aus1sb3dl8L5WoTOO0g7/lifecycle/deactivate"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/policies"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/policies/00p5m9xrrBffPd9ah0g4"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/scopes"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/scopes/scpanemfdtktNn7w10h7"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/scopes/00p5m9xrrBffPd9ah0g4"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/claims"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/claims/scpanemfdtktNn7w10h7"
~~~
...
}' "https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/claims/oclain6za1HQ0noop0h7"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/credentials/keys"
~~~
  ...
  "keys": [
   {
      ...
      "_links": {
        "self": {
          "href": "https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/credentials/keys/RQ8DuhdxCczyMvy7GNJb4Ka3lQ99vrSo3oFBUiZjzzc",
          "hints": {
            "allow": [
              "GET"
            ]
    ...
    },
    {
      ...
      "_links": {
        "self": {
          "href": "https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/credentials/keys/Y3vBOdYT-l-I0j-gRQ26XjutSX00TeWiSguuDhW3ngo",
          "hints": {
            "allow": [
              "GET"
            ]
    ...
    },
    {
      ...
      "_links": {
        "self": {
          "href": "https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/credentials/keys/h5Sr3LXcpQiQlAUVPdhrdLFoIvkhRTAVs_h39bQnxlU",
          "hints": {
            "allow": [
              "GET"
            ]
...
-d '{
  "use": "sig"
}' "https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/credentials/lifecycle/keyRotate"
~~~
...
~~~json
{
  "keys": [
    ...
    },
             {
               ...
               "_links": {
                 "self": {
                 "href": "https://{oktaDomain}.com/api/v1/authorizationServers/ausnsopoM6vBRB3PD0g3/credentials/keys/T5dZ1dYT-l-I0j-gRQ82XjutSX00TeWiSguuDhW3zdf",
                 "hints": {
                   "allow": [
                     "GET"
                   ]
...
~~~json
{
  ...
  "issuer": "https://{oktaDomain}.com/oauth2/ausain6z9zIedDCxB0h7",
  "status": "ACTIVE",
  ...
  "_links": {
      "scopes": {
        "href": "https://{oktaDomain}.com/api/v1/authorizationServers/ausain6z9zIedDCxB0h7/scopes",
        "hints": {
          "allow": [
            "GET"
          ]
      ...
      "claims": {
        "href": "https://{oktaDomain}.com/api/v1/authorizationServers/ausain6z9zIedDCxB0h7/claims",
        "hints": {
          "allow": [
            "GET"
          ]
      ...
      "policies": {
        "href": "https://{oktaDomain}.com/api/v1/authorizationServers/ausain6z9zIedDCxB0h7/policies",
        "hints": {
          "allow": [
            "GET"
          ]
    ...
    "self": {
      "href": "https:{oktaDomain}.com/api/v1/authorizationServers/ausain6z9zIedDCxB0h7",
      "hints": {
        "allow": [
          "GET",
          "DELETE",
    ...
    "metadata": [
      {
        ...
        "href": "https:{oktaDomain}.com/oauth2/ausain6z9zIedDCxB0h7/.well-known/oauth-authorization-server",
        "hints": {
          "allow": [
            "GET"
          ]
      ...
      },
      {
        ...
        "href": "{oktaDomain}.com/oauth2/ausain6z9zIedDCxB0h7/.well-known/openid-configuration",
        "hints": {
          "allow": [
            "GET"
          ]
    ...
    "rotateKey": {
      "href": "https://{oktaDomain}.com/api/v1/authorizationServers/ausain6z9zIedDCxB0h7/credentials/lifecycle/keyRotate",
      "hints": {
        "allow": [
          "POST"
        ]
    ...
    "deactivate": {
          "href": "https://{oktaDomain}.com/api/v1/authorizationServers/ausain6z9zIedDCxB0h7/lifecycle/deactivate",
          "hints": {
            "allow": [
              "POST"
        ]
...
~~~json
{
    ...
    "_links": {
      "self": {
        "href": "{oktaDomain}.com/api/v1/authorizationServers/ausain6z9zIedDCxB0h7/policies/00palyaappA22DPkj0h7",
        "hints": {
          "allow": [
            "GET",
            "PUT",
      ...
      "deactivate": {
        "href": "{oktaDomain}.com/api/v1/authorizationServers/ausain6z9zIedDCxB0h7/policies/00palyaappA22DPkj0h7/lifecycle/deactivate",
        "hints": {
          "allow": [
            "POST"
          ]
      ...
      "rules": {
        "href": "https://{oktaDomain}.com/api/v1/authorizationServers/ausain6z9zIedDCxB0h7/policies/00palyaappA22DPkj0h7/rules",
        "hints": {
          "allow": [
            "GET"
          ]
