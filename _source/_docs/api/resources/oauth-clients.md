...
-d '{
      ...
      "token_endpoint_auth_method": "client_secret_post",
      "initiate_login_uri": "https://www.example-application.com/oauth2/login"
    }' "https://{oktaDomain}.com/oauth2/v1/clients"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/oauth2/v1/clients/0jrabyQWm4B9zVJPbotY"
~~~
...
~~~
~~~json
Link: <https://{oktaDomain}.com/oauth2/v1/clients>; rel="self"
Link: <https://{oktaDomain}.com/oauth2/v1/clients?after=F10CaazJPQ5Zpyu1Ojko>; rel="next"
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/oauth2/v1/clients?q=Payroll&limit=10"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
 "https://{oktaDomain}.com/oauth2/v1/clients/0jrabyQWm4B9zVJPbotY/lifecycle/newSecret"
~~~
