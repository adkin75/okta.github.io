...
}' "https://{oktaDomain}.com/api/v1/authn"
~~~
...
~~~json
{
  ...
  "_links": {
    "next": {
      "name": "unlock",
      "href": "https://{oktaDomain}.com/api/v1/authn/recovery/unlock",
      "hints": {
        "allow": [
          "POST"
        ]
...
~~~json
{
  ...
  "_links": {
    "next": {
      "name": "changePassword",
      "href": "https://{oktaDomain}.com/api/v1/authn/credentials/change_password",
      "hints": {
        "allow": [
          "POST"
        ]
    ...
    "cancel": {
      "href": "https://{oktaDomain}.com/api/v1/authn/cancel",
      "hints": {
        "allow": [
          "POST"
        ]
    ...
    "factors": [
      {
        ...
        "_links": {
          "verify": {
            "href": "https://{oktaDomain}.com/api/v1/authn/factors/rsalhpMQVYKHZKXZJQEW/verify",
            "hints": {
              "allow": [
                "POST"
              ]
      ...
      },
      {
        ...
        "_links": {
          "verify": {
            "href": "https://{oktaDomain}.com/api/v1/authn/factors/ostfm3hPNYSOIOIVTQWY/verify",
            "hints": {
              "allow": [
                "POST"
              ]
      ...
      },
      {
        ...
        "_links": {
          "verify": {
            "href": "https://{oktaDomain}.com/api/v1/authn/factors/sms193zUBEROPBNZKPPE/verify",
            "hints": {
              "allow": [
                "POST"
              ]
      ...
      },
      {
         ...
         "_links": {
           "verify": {
             "href": "https://{oktaDomain}.com/api/v1/authn/factors/clf193zUBEROPBNZKPPE/verify",
             "hints": {
               "allow": [
                 "POST"
                ]
      ...
      },
      {
        ...
        "_links": {
          "verify": {
            "href": "https://{oktaDomain}.com/api/v1/authn/factors/opf3hkfocI4JTLAju0g4/verify",
            "hints": {
              "allow": [
                "POST"
              ]
    ...
    "factors": [
      {
        ...
        "_links": {
          "enroll": {
            "href": "https://{oktaDomain}.com/api/v1/authn/factors",
            "hints": {
              "allow": [
                "POST"
              ]
    ...
    "factors": [
      {
        ...
        "_links": {
          "questions": {
            "href": "https://{oktaDomain}.com/api/v1/users/00u1nehnZ6qp4Qy8G0g4/factors/questions",
            "hints": {
              "allow": [
                "GET"
              ]
...
~~~json
{
  ...
  "_links": {
    "next": {
      "name": "resetPassword",
      "href": "https://{oktaDomain}.com/api/v1/authn/credentials/reset_password",
      "hints": {
        "allow": [
          "POST"
        ]
...
~~~json
{
  ...
  "_links": {
    ...
    "skip": {
      "name": "skip",
      "href": "https://{oktaDomain}.com/api/v1/authn/skip",
      "hints": {
        "allow": [
          "POST"
        ]
...
~~~json
{
   ...
   "_embedded":{
      "target":{
         ...
         "_links":{
            "logo":{
               "name":"medium",
               "href":"https://{oktaDomain}.com/assets/img/logos/salesforce_logo.dbd7e0b4de118a1dae1c39d60a3c30e5.png",
               "type":"image/png"
            }
         }
      }
   ...
   "_links":{
      "next":{
         "name":"authenticate",
         "href":"https://{oktaDomain}.com/api/v1/authn",
         "hints":{
            "allow":[
               "POST"
            ]
...
~~~json
{
   ...
   "_links":{
      "next":{
         "name":"original",
         "href":"https://{oktaDomain}.com/login/step-up/redirect?stateToken=00quAZYqYjXg9DZhS5UzE1wrJuQ6KKb_kzOeH7OGB5",
         "hints":{
            "allow":[
               "GET"
            ]
      ...
      "factors":[
         {
            ...
            "_links":{
               "verify":{
                  "href":"https://{oktaDomain}.com/api/v1/authn/factors/smsph8F1esz8LlSjo0g3/verify",
                  "hints":{
                     "allow":[
                        "POST"
                     ]
...
}' "https://{oktaDomain}.com/api/v1/authn/credentials/change_password"
~~~
...
}' "https://{oktaDomain}.com/api/v1/authn/factors"
~~~
...
~~~json
{
  ...
  "_links": {
    "next": {
      "name": "activate",
      "href": "https://{oktaDomain}.com/api/v1/authn/factors/mbl198rKSEWOSKRIVIFT/lifecycle/activate",
      "hints": {
        "allow": [
          "POST"
        ]
    ...
    "prev": {
      "href": "https://{oktaDomain}.com/api/v1/authn/previous",
      "hints": {
        "allow": [
          "POST"
        ]
    ...
    "resend": [
      {
        "name": "sms",
        "href": "https://{oktaDomain}.com/api/v1/authn/factors/mbl198rKSEWOSKRIVIFT/lifecycle/resend",
        "hints": {
          "allow": [
            "POST"
          ]
...
~~~json
{
  ...
  "_links": {
    "next": {
      "name": "activate",
      "href": "https://{oktaDomain}.com/api/v1/authn/factors/clf198rKSEWOSKRIVIFT/lifecycle/activate",
      "hints": {
        "allow": [
          "POST"
        ]
    ...
    "resend": [
      {
        "name": "call",
        "href": "https://{oktaDomain}.com/api/v1/authn/factors/clf198rKSEWOSKRIVIFT/lifecycle/resend",
        "hints": {
          "allow": [
            "POST"
          ]
...
~~~json
{
    ...
    "factor": {
      ...
      "_embedded": {
        "activation": {
          ...
          "_links": {
            "qrcode": {
              "href": "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/factors/ostf2xjtDKWFPZIKYDZV/qr/00Mb0zqhJQohwCDkB2wOifajAsAosEAXvDwuCmsAZs",
              "type": "image/png"
            }
          }
        }
  ...
  "_links": {
    "next": {
      "name": "activate",
      "href": "https://{oktaDomain}.com/api/v1/authn/factors/ostf2xjtDKWFPZIKYDZV/lifecycle/activate",
      "hints": {
        "allow": [
          "POST"
        ]
...
~~~json
{
    ...
    "factor": {
      ...
      "_embedded": {
        "activation": {
          ...
          "_links": {
            "qrcode": {
              "href": "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/factors/opfh52xcuft3J4uZc0g3/qr/00fukNElRS_Tz6k-CFhg3pH4KO2dj2guhmaapXWbc4",
              "type": "image/png"
            },
            "send": [
              {
                "name": "email",
                "href": "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/factors/opfh52xcuft3J4uZc0g3/lifecycle/activate/email",
                "hints": {
                  "allow": [
                    "POST"
                  ]
              ...
              {
                "name": "sms",
                "href": "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/factors/opfh52xcuft3J4uZc0g3/lifecycle/activate/sms",
                "hints": {
                  "allow": [
                    "POST"
                  ]
  ...
  "_links": {
    "next": {
      "name": "poll",
      "href": "https://{oktaDomain}.com/api/v1/authn/factors/opfh52xcuft3J4uZc0g3/lifecycle/activate/poll",
      "hints": {
        "allow": [
          "POST"
        ]
...
~~~json
{
    ...
    "factor": {
      ...
      "_embedded": {
        "activation": {
          ...
          "_links": {
            "qrcode": {
              "href": "https://{oktaDomain}.com/api/v1/users/00ub0oNGTSWTBKOLGLNR/factors/uftm3iHSGFQXHCUSDAND/qr/00Mb0zqhJQohwCDkB2wOifajAsAosEAXvDwuCmsAZs",
              "type": "image/png"
            }
          }
        }
  ...
  "_links": {
    "next": {
      "name": "activate",
      "href": "https://{oktaDomain}.com/api/v1/authn/factors/uftm3iHSGFQXHCUSDAND/lifecycle/activate",
      "hints": {
        "allow": [
          "POST"
        ]
...
~~~json
{
      ...
      "factor":{
          ...
          "_embedded":{
              "activation":{
                  ...
                  "_links":{
                      "complete":{
                          "href":"https://{oktaDomain}.com/api/v1/authn/factors/dsflnpo99zpfMyaij0g3/lifecycle/duoCallback",
                          "hints":{
                              "allow":[
                                  "POST"
                             ]
                      ...
                      "script":{
                          "href":"https://{oktaDomain}.com/js/sections/duo/Duo-Web-v2.js",
  ...
  "_links":{
      "next":{
          "name":"poll",
          "href":"https://{oktaDomain}.com/api/v1/authn/factors/dsflnpo99zpfMyaij0g3/lifecycle/activate/poll",
          "hints":{
              "allow":[
                   "POST"
              ]
...
<html>
    <body>
        ...
        <script src="https://{oktaDomain}.com/js/sections/duo/Duo-Web-v2.js"></script>
        ...
        <script>
            Duo.init({
                ...
                'post_action': 'https://{oktaDomain}.com/api/v1/authn/factors/dsflnpo99zpfMyaij0g3/lifecycle/duoCallback'
            });
        </script>
    </body>
</html>
...
-d '{
  "stateToken": "$(stateToken}"
}' "https://{oktaDomain}.com/api/v1/authn/factors/${factorId}/lifecycle/activate/poll"
~~~
...
~~~json
{
  ...
  "_links": {
    "next": {
      "name": "activate",
      "href": "https://{oktaDomain}.com/api/v1/authn/factors/fuf8y1y14jaygfX5K0h7/lifecycle/activate",
      "hints": {
        "allow": [
          "POST"
        ]
...
-d '{
  "stateToken": "007ucIX7PATyn94hsHfOLVaXAmOBkKHWnOOLG43bsb",
  "passCode": "123456"
}' "https://{oktaDomain}.com/api/v1/authn/factors/ostf1fmaMGJLMNGNLIVG/lifecycle/activate"
~~~
...
-d '{
  "stateToken": "007ucIX7PATyn94hsHfOLVaXAmOBkKHWnOOLG43bsb",
  "passCode": "123456"
}' "https://{oktaDomain}.com/api/v1/authn/factors/sms1o51EADOTFXHHBXBP/lifecycle/activate"
~~~
...
-d '{
  "stateToken": "007ucIX7PATyn94hsHfOLVaXAmOBkKHWnOOLG43bsb",
  "passCode": "12345"
}' "https://{oktaDomain}.com/api/v1/authn/factors/clf1o51EADOTFXHHBXBP/lifecycle/activate"
~~~
...
-d '{
  "stateToken": "007ucIX7PATyn94hsHfOLVaXAmOBkKHWnOOLG43bsb",
}' "https://{oktaDomain}.com/api/v1/authn/factors/opfh52xcuft3J4uZc0g3/lifecycle/activate"
~~~
...
~~~json
{
    ...
    "factor": {
      ...
      "_embedded": {
        "activation": {
          ...
          "_links": {
            "activate": {
              "href": "https://{oktaDomain}.com/api/v1/users/00u4vi0VX6U816Kl90g4/factors/opfh52xcuft3J4uZc0g3/lifecycle/activate",
              "hints": {
                "allow": [
                  "POST"
                ]
            ...
            "send": [
              {
                "name": "email",
                "href": "https://{oktaDomain}.com/api/v1/authn/factors/opfh52xcuft3J4uZc0g3/lifecycle/activate/email",
                "hints": {
                  "allow": [
                    "POST"
                  ]
              ...
              {
                "name": "sms",
                "href": "https://{oktaDomain}.com/api/v1/authn/factors/opfh52xcuft3J4uZc0g3/lifecycle/activate/sms",
                "hints": {
                  "allow": [
                    "POST"
                  ]
  ...
  "_links": {
    "next": {
      "name": "activate",
      "href": "https://{oktaDomain}.com/api/v1/authn/factors/opfh52xcuft3J4uZc0g3/lifecycle/activate",
      "hints": {
        "allow": [
          "POST"
        ]
...
-d '{
  "stateToken": "007ucIX7PATyn94hsHfOLVaXAmOBkKHWnOOLG43bsb"
}' "https://{oktaDomain}.com/api/v1/authn/factors/opfh52xcuft3J4uZc0g3/lifecycle/activate/poll"
~~~
      ...
      "_embedded":{
        "activation":{
          ...
          "_links":{
            ...
            "qrcode":{
              "href":"https://{oktaDomain}.com/api/v1/users/opfh52xcuft3J4uZc0g3/factors/opfn169oIx3k63Klh0g3/qr/20111huUFWDFTAeq_lFQKfKFS_rLABkE_pKgGl5PBUeLvJVmaIrWq5u",
              "type":"image/png"
            }
          }
        }
...
-d '{
  "stateToken": "007ucIX7PATyn94hsHfOLVaXAmOBkKHWnOOLG43bsb"
}' "https://{oktaDomain}.com/api/v1/authn/factors/opfh52xcuft3J4uZc0g3/lifecycle/activate/email"
~~~
...
}' "https://{oktaDomain}.com/api/v1/authn/factors/opfh52xcuft3J4uZc0g3/lifecycle/activate/sms"
~~~
...
}' "https://{oktaDomain}.com/api/v1/authn/factors/fuf1o51EADOTFXHHBXBP/lifecycle/activate"
~~~
...
-d '{
  "stateToken": "007ucIX7PATyn94hsHfOLVaXAmOBkKHWnOOLG43bsb",
  "answer": "mayonnaise"
}' "https://{oktaDomain}.com/api/v1/authn/factors/ufs1pe3ISGKGPYKXRBKK/verify"
~~~
...
-d '{
  "stateToken": "007ucIX7PATyn94hsHfOLVaXAmOBkKHWnOOLG43bsb"
}' "https://{oktaDomain}.com/api/v1/authn/factors/sms193zUBEROPBNZKPPE/verify"
~~~
...
~~~json
{
  ...
  "_links": {
    ...
    "resend": [
      {
        "name": "sms",
        "href": "https://{oktaDomain}.com/api/v1/authn/factors/sms193zUBEROPBNZKPPE/verify/resend",
        "hints": {
          "allow": [
            "POST"
          ]
...
-d '{
  "stateToken": "007ucIX7PATyn94hsHfOLVaXAmOBkKHWnOOLG43bsb",
  "passCode": "657866"
}' "https://{oktaDomain}.com/api/v1/authn/factors/ostfm3hPNYSOIOIVTQWY/verify"
~~~
...
~~~json
{
  ...
  "_links": {
    "next": {
      "name": "poll",
      "href": "https://{oktaDomain}.com/api/v1/authn/factors/opfh52xcuft3J4uZc0g3/verify",
      "hints": {
        "allow": [
          "POST"
        ]
    ...
    "resend": [
      {
        "name": "push",
        "href": "https://{oktaDomain}.com/api/v1/authn/factors/opfh52xcuft3J4uZc0g3/verify/resend",
        "hints": {
          "allow": [
            "POST"
          ]
...
-d '{
  "stateToken": "${stateToken}"
}' "https://{oktaDomain}.com/api/v1/authn/factors/${factorId]/verify"
~~~
...
~~~json
{
    ...
    "_links":{
        "next":{
            "name":"poll",
            "href":"https://{oktaDomain}.com/api/v1/authn/factors/dsflnpo99zpfMyaij0g3/verify",
            "hints":{
                "allow":[
                    "POST"
                ]
...
~~~json
{
   ...
   "_links":{
      "next":{
         "name":"verify",
         "href":"https://{oktaDomain}.com/api/v1/authn/factors/fuf8y2l4n5mfH0UWe0h7/verify",
         "hints":{
            "allow":[
               "POST"
            ]
...
-d '{
  "stateToken": "007ucIX7PATyn94hsHfOLVaXAmOBkKHWnOOLG43bsb"
}' "https://{oktaDomain}.com/api/v1/authn/factors/clf193zUBEROPBNZKPPE/verify"
~~~
...
-d '{
  ...
  "factorType": "EMAIL",
  "relayState": "/myapp/some/deep/link/i/want/to/return/to"
}' "https://{oktaDomain}.com/api/v1/authn/recovery/password"
~~~
...
~~~json
{
  ...
  "_links": {
    "next": {
      "name": "verify",
      "href": "https://{oktaDomain}.com/api/v1/authn/recovery/factors/SMS/verify",
      "hints": {
        "allow": [
          "POST"
        ]
    ...
    "resend": {
      "name": "sms",
      "href": "https://{oktaDomain}.com/api/v1/authn/recovery/factors/SMS/resend",
      "hints": {
        "allow": [
          "POST"
        ]
...
~~~json
{
  ...
  "_links": {
    "next": {
      "name": "verify",
      "href": "https://{oktaDomain}.com/api/v1/authn/recovery/factors/CALL/verify",
      "hints": {
        "allow": [
          "POST"
        ]
    ...
    "resend": {
      "name": "call",
      "href": "https://{oktaDomain}.com/api/v1/authn/recovery/factors/CALL/resend",
      "hints": {
        "allow": [
          "POST"
        ]
...
~~~json
{
  ...
  "_links": {
    "next": {
      "name": "recovery",
      "href": "https://{oktaDomain}.com/api/v1/authn/recovery/token",
      "hints": {
        "allow": [
          "POST"
        ]
...
-d '{
  ...
  "factorType": "EMAIL",
  "relayState": "/myapp/some/deep/link/i/want/to/return/to"
}' "https://{oktaDomain}.com/api/v1/authn/recovery/unlock"
~~~
...
-d '{
  "stateToken": "00xdqXOE5qDXX8-PBR1bYv8AESqIEinDy3yul01tyh",
  "passCode": "657866"
}' "https://{oktaDomain}.com/api/v1/authn/factors/sms/verify"
~~~
...
~~~json
{
  ...
  "_links": {
    "next": {
      "name": "answer",
      "href": "https://{oktaDomain}.com/api/v1/authn/recovery/answer",
      "hints": {
        "allow": [
          "POST"
        ]
...
-d '{
  "stateToken": "00xdqXOE5qDXX8-PBR1bYv8AESqIEinDy3yul01tyh"
}' "https://{oktaDomain}.com/api/v1/authn/recovery/factors/sms/resend"
~~~
...
-d '{
  "stateToken": "00xdqXOE5qDXX8-PBR1bYv8AESqIEinDy3yul01tyh",
  "passCode": "65786"
}' "https://{oktaDomain}.com/api/v1/authn/factors/CALL/verify"
~~~
...
-d '{
  "stateToken": "00xdqXOE5qDXX8-PBR1bYv8AESqIEinDy3yul01tyh"
}' "https://{oktaDomain}.com/api/v1/authn/recovery/factors/CALL/resend"
~~~
...
}' "https://{oktaDomain}.com/api/v1/authn/recovery/token"
~~~
...
-d '{
  "stateToken": "00lMJySRYNz3u_rKQrsLvLrzxiARgivP8FB_1gpmVb",
  "answer": "Annie Oakley"
}' "https://{oktaDomain}.com/api/v1/authn/recovery/answer"
~~~
...
-d '{
  "stateToken": "00lMJySRYNz3u_rKQrsLvLrzxiARgivP8FB_1gpmVb",
  "newPassword": "Ch-ch-ch-ch-Changes!"
}' "https://{oktaDomain}.com/api/v1/authn/credentials/reset_password"
~~~
...
-d '{
  "stateToken": "00lMJySRYNz3u_rKQrsLvLrzxiARgivP8FB_1gpmVb"
}' "https://{oktaDomain}.com/api/v1/authn/previous"
~~~
...
-d '{
  "stateToken": "00lMJySRYNz3u_rKQrsLvLrzxiARgivP8FB_1gpmVb"
}' "https://{oktaDomain}.com/api/v1/authn/skip"
~~~
...
-d '{
  "stateToken": "00lMJySRYNz3u_rKQrsLvLrzxiARgivP8FB_1gpmVb"
}' "https://{oktaDomain}.com/api/v1/authn/cancel"
~~~
