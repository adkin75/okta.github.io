...
| iss           | The Issuer Identifier of the response.                                                                                                                                     | String    | "https://{oktaDomain}.com"                         |
...
"https://{oktaDomain}..com/oauth2/v1/userinfo"
~~~
...
~~~json
{
    ...
    "end_session_endpoint": "https://{oktaDomain}..com/oauth2/v1/logout"
}
~~~
...
"https://{oktaDomain}..com/oauth2/v1/authorize?
  client_id=${client_id}&
  response_type=code&
...
~~~sh
curl -v -X GET \
"https://{oktaDomain}..com/oauth2/v1/logout?
