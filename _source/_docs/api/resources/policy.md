...
"https://{oktaDomain}..com/api/v1/policies/{policyId}"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}..com/api/v1/policies/{policyId}?expand=rules"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}..com/api/v1/policies?type={type}"
~~~
...
"https://{oktaDomain}..com/api/v1/policies"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}..com/api/v1/policies/{policyId}/lifecycle/activate"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}..com/api/v1/policies/{policyId}/lifecycle/deactivate"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}..com/api/v1/policies/{policyId}/rules"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}..com/api/v1/policies/{policyId}/rules/{ruleId}"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}..com/api/v1/policies/{policyId}/rules/{ruleId}/lifecycle/activate"
~~~
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}..com/api/v1/policies/{policyId}/rules/{ruleId}/lifecycle/deactivate"
~~~
