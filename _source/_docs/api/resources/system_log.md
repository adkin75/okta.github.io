...
"https://{oktaDomain}.com/api/v1/logs?q=Jane+Doe"
```
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/logs?filter=event_type+eq+%22user.session.start%22"
```
...
-H "Content-Type: application/json" \
-H "Authorization: SSWS ${api_token}" \
"https://{oktaDomain}.com/api/v1/logs?since=2017-03-11"
```
...
For example:
```
Link: <https://{oktaDomain}.com/api/v1/logs?q=&sortOrder=DESCENDING&limit=20&until=2017-03-17T23%3A59%3A59%2B00%3A00&since=2017-03-10T00%3A00%3A00%2B00%3A00>; rel="self"
```
...
For example:
```
Link: <https://{oktaDomain}.com/api/v1/logs?q=&sortOrder=DESCENDING&limit=20&until=2017-03-17T15%3A41%3A12.994Z&after=349996bd-5091-45dc-a39f-d357867a30d7&since=2017-03-10T00%3A00%3A00%2B00%3A00>; rel="next"
```
