...
-X GET "https://{oktaDomain}.com/api/v1/org/factors"
~~~
...
~~~json
{
        ...
        "_links": {
            "self": {
                "href": "https://{oktaDomain}.com/api/v1/org/factors/google_otp",
                "hints": {
                    "allow": [
                        "GET"
                    ]
            ...
            "deactivate": {
                "href": "https://{oktaDomain}.com/api/v1/org/factors/google_otp/lifecycle/deactivate",
                "hints": {
                    "allow": [
                        "POST"
                    ]
    ...
    },
    {
        ...
        "_links": {
            "activate": {
                "href": "https://{oktaDomain}.com/api/v1/org/factors/okta_question/lifecycle/activate",
                "hints": {
                    "allow": [
                        "POST"
                    ]
            ...
            "self": {
                "href": "https://{oktaDomain}.com/api/v1/org/factors/okta_question",
                "hints": {
                    "allow": [
                        "GET"
                    ]
    ...
    },
    {
        ...
        "_links": {
            "self": {
                "href": "https://{oktaDomain}.com/api/v1/org/factors/okta_otp",
                "hints": {
                    "allow": [
                        "GET"
                    ]
    ...
    },
    {
        ...
        "_links": {
            "self": {
                "href": "https://{oktaDomain}.com/api/v1/org/factors/okta_sms",
                "hints": {
                    "allow": [
                        "GET"
                    ]
            ...
            "deactivate": {
                "href": "https://{oktaDomain}.com/api/v1/org/factors/okta_sms/lifecycle/deactivate",
                "hints": {
                    "allow": [
                        "POST"
                    ]
    ...
    },
    {
        ...
        "_links": {
            ...
            "self": {
                "href": "https://{oktaDomain}.com/api/v1/org/factors/symantec_vip",
                "hints": {
                    "allow": [
                        "GET"
                    ]
    ...
    },
    {
        ...
        "_links": {
            "activate": {
                "href": "https://{oktaDomain}.com/api/v1/org/factors/rsa_token/lifecycle/activate",
                "hints": {
                    "allow": [
                        "POST"
                    ]
            ...
            "self": {
                "href": "https://{oktaDomain}.com/api/v1/org/factors/rsa_token",
                "hints": {
                    "allow": [
                        "GET"
                    ]
...
-H "Accept: application/json" \
-H "Content-Type: application/json" \
-X POST "https://{oktaDomain}.com/api/v1/org/factors/okta_sms/lifecycle/activate"
~~~
...
-H "Accept: application/json" \
-H "Content-Type: application/json" \
-X POST "https://{oktaDomain}.com/api/v1/org/factors/okta_sms/lifecycle/deactivate"
~~~
...
~~~json
{
    ...
    "_links": {
        "activate": {
            "href": "https://{oktaDomain}.com/api/v1/org/factors/okta_sms/lifecycle/activate",
            "hints": {
                "allow": [
                    "POST"
                ]
...
-H "Accept: application/json" \
-H "Content-Type: application/json" \
-X POST "https://{oktaDomain}.com/api/v1/org/factors/okta_otp/lifecycle/activate"
~~~
...
~~~json
{
    ...
    "_links": {
        ...
        "deactivate": {
            "href": "https://{oktaDomain}.com/api/v1/org/factors/okta_otp/lifecycle/deactivate",
            "hints": {
                "allow": [
                    "POST"
                ]
...
-H "Accept: application/json" \
-H "Content-Type: application/json" \
-X POST "https://{oktaDomain}.com/api/v1/org/factors/okta_otp/lifecycle/deactivate"
~~~
...
~~~json
{
    ...
    "_links": {
        "activate": {
            "href": "https://{oktaDomain}.com/api/v1/org/factors/okta_otp/lifecycle/activate",
            "hints": {
                "allow": [
                    "POST"
                ]
